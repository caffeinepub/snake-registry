...
export class Backend implements backendInterface {
    ...
    async getNumberOfUsers(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getNumberOfUsers();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSnakeSegments(): Promise<Array<Segment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSnakeSegments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
